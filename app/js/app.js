(function() {
  ...
  angular.module('bikingList', [])
    ...
    .directive('rideCategories', function() {
      return {
        restrict: 'E',
        templateUrl: 'partials/ride-categories.html'
      }
    })
  ...
  //data
  var categories = ['road', 'gravel', 'mountain', 'fatbike', 'cyclocross'];
  ...
  var rides = [
    {
      ...
      categories: {'gravel': true, 'road': true, 'moutain': false},
